...
private func beCloseTo(
    ...
    public extension NMBPredicate {
        @objc class func beCloseToMatcher(_ expected: NSNumber, within: CDouble) -> NMBObjCBeCloseToPredicate {
...
public extension Expectation where T: Collection, T.Element: FloatingPoint {
    // swiftlint:disable:next identifier_name
    static func ≈ (lhs: Expectation, rhs: T) {
        lhs.to(beCloseTo(rhs))
    }
}

public extension Expectation where T: FloatingPoint {
    // swiftlint:disable:next identifier_name
    static func ≈ (lhs: Expectation, rhs: T) {
        lhs.to(beCloseTo(rhs))
    }
    ...
    // swiftlint:disable:next identifier_name
    static func ≈ (lhs: Expectation, rhs: (expected: T, delta: T)) {
...
public extension Expectation where T: NMBDoubleConvertible {
    // swiftlint:disable:next identifier_name
    static func ≈ (lhs: Expectation, rhs: T) {
        lhs.to(beCloseTo(rhs))
    }
    ...
    // swiftlint:disable:next identifier_name
    static func ≈ (lhs: Expectation, rhs: (expected: T, delta: Double)) {
        lhs.to(beCloseTo(rhs.expected, within: rhs.delta))
    }
